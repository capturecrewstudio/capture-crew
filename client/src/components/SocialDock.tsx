...
const LINKS: SocialLink[] = [
  {
    id: 'whatsapp', label: 'WhatsApp', href: 'https://wa.me/yournumber', color: '#25D366',
    Icon: () => (
  ...
  {
    id: 'contact', label: 'Call Us', href: 'tel:+yourphone', color: '#7C3AED',
    Icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
  ...
  {
    id: 'instagram', label: 'Instagram', href: 'https://instagram.com/capturecrew', color: '#E1306C',
    Icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
  ...
  {
    id: 'youtube', label: 'YouTube', href: 'https://youtube.com/@capturecrew', color: '#FF0000',
    Icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
  ...
  {
    id: 'linkedin', label: 'LinkedIn', href: 'https://linkedin.com/company/capturecrew', color: '#0A66C2',
    Icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
...
export function SocialDock() {
  ...
  const [shown,   setShown]     = useState<boolean[]>(LINKS.map(() => false));
  ...
  useEffect(() => {
    ...
    if (open) {
      ...
      LINKS.slice().reverse().forEach((_, ri) => {
        const i = LINKS.length - 1 - ri;
        const t = setTimeout(() => {
