...
function Lightbox({ images, startIndex, title, onClose }: LightboxProps) {
  ...
  return (
    ...
    >
      ...
      {/* Main image area */}
      <div className="relative flex-1 flex items-center justify-center min-h-0 px-16 py-6">
        {/* Prev */}
        <button
          onClick={prev}
          aria-label="Previous"
          className="absolute left-3 sm:left-5 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full transition-all duration-200 hover:scale-110"
        ...
        <button
          onClick={next}
          aria-label="Next"
          className="absolute right-3 sm:right-5 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full transition-all duration-200 hover:scale-110"
          style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)', color: 'rgba(255,255,255,0.8)' }}
        >
